      ...
      <StyledMenu ref={node as any}>
        ...
        {open && (
          <PopoverContainer show={true} ref={setPopperElement as any} style={styles.popper} {...attributes.popper}>
            ...
            <SeparatorDark />
            <ExternalLink href={`https://tokens.kimchiswap.io/token-list?url=${listUrl}`}>View list</ExternalLink>
  ...
  return (
    <Column style={{ width: '100%', flex: '1 1' }}>
      ...
      <div style={{ padding: '16px', textAlign: 'center' }}>
        <ExternalLink href="https://tokens.kimchiswap.io">Browse lists</ExternalLink>
      </div>
    </Column>
  )
}
