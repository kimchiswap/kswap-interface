  ...
  describe('updateVersion', () => {
    ...
    describe('initialized with a different set of lists', () => {
      ...
      it('each of those initialized lists is empty', () => {
        ...
        // note we don't expect the kimchiswap default list to be prepopulated
        // this is ok.
        Object.keys(byUrl).forEach(url => {
          if (url !== 'https://unpkg.com/@kimchiswap/default-token-list@latest/kimchiswap-default.tokenlist.json') {
