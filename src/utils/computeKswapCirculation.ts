import { JSBI, Token, TokenAmount } from '@kimchiswap/sdk'
...
export function computeKswapCirculation(
  kswap: Token,
  blockTimestamp: BigNumber,
  unclaimedKswap: TokenAmount | undefined
): TokenAmount {
  ...
  const total = new TokenAmount(kswap, JSBI.multiply(wholeAmount, JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(18))))
  return unclaimedKswap ? total.subtract(unclaimedKswap) : total
}
