...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from '@kimchiswap/sdk'
                ...
                return contract.callStatic[methodName](...args, options)
                  ...
                  .catch(callError => {
                    ...
                    switch (callError.reason) {
                      case 'KswapV1Router: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'KswapV1Router: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =
